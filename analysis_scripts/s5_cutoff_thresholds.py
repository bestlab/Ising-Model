...
f_params = [
    'Trp-cage/DESRES-Trajectory_2JOF-0-protein/Contacts/Ising_Model/network_size_stable_2JOF.dat',
    'BBA/Combined_1FME/Ising_Model/network_size_stable_BBA.dat',
    'Villin/DESRES-Trajectory_2F4K-0-protein/Contacts/Ising_Model/network_size_stable_villin.dat',
    'WW domain/Combined_GTT/Ising_Model/network_size_stable_ww_domain.dat',
    'Ntl9/Combined_NTL9/Ising_Model/network_size_stable_Ntl9.dat',
    'Protein G/Combined_NuG2/Ising_Model/network_size_stable_NuG2.dat',
    'A3D/Combined_A3D/Ising_Model/network_size_stable_A3D.dat',
    'Ubiquitin/Combined_1UBQ/Ising_Model/network_size_stable_1ubq.dat',
    'l-repressor/Combined_lambda/Ising_Model/network_size_stable_lambda.dat']
...
out_f = "s5_network_size_cutoffs.png"
plt.savefig(out_f)
plt.close()
