...
def get_largest_coop_network(f_param,numResid,cutoff):
    ...
    return lstNetworks[network_size[0]['index']], adjList

# main function which calls up all other functions
if __name__ == "__main__":
# initialize variables
    f_params = [
        'Trp-cage/DESRES-Trajectory_2JOF-0-protein/Contacts/Ising_Model_all/trp-cage_stable_all.bm_param',
        'BBA/Combined_1FME/Ising_Model_all/bba_stable_all.bm_param',
        'Villin/DESRES-Trajectory_2F4K-0-protein/Contacts/Ising_Model_all/villin_stable_all.bm_param',
        'WW domain/Combined_GTT/Ising_Model_all/ww_domain_stable_all.bm_param',
        'Ntl9/Combined_NTL9/Ising_Model_all/ntl9_stable_all.bm_param',
        'Protein G/Combined_NuG2/Ising_Model_all/nug2_stable_all.bm_param',
        'A3D/Combined_A3D/Ising_Model_all/a3d_stable_all.bm_param',
        'Ubiquitin/Combined_1UBQ/Ising_Model_10ns_filter_all/params_curr.txt',
        'l-repressor/Combined_lambda/Ising_Model_all/lambda_stable_all.bm_param']
    f_templates = [
        'Trp-cage/DESRES-Trajectory_2JOF-0-protein/Contacts/Ising_Model_all/2JOF_native.pdb',
        'BBA/Combined_1FME/Ising_Model_all/1FME_native.pdb',
        'Villin/DESRES-Trajectory_2F4K-0-protein/Contacts/Ising_Model_all/template_2F4K.pdb',
        'WW domain/Combined_GTT/Ising_Model_all/template_GTT.pdb',
        'Ntl9/Combined_NTL9/Ising_Model_all/NTL9_native.pdb',
        'Protein G/Combined_NuG2/Ising_Model_all/template_NuG2.pdb',
        'A3D/Combined_A3D/Ising_Model_all/A3D_native.pdb',
        'Ubiquitin/Combined_1UBQ/Ising_Model_10ns_filter_all/template_1ubq.pdb',
        'l-repressor/Combined_lambda/Ising_Model_all/lambda_native.pdb']
...
lst_coop_cutoff = [5.2,7.2,4.3,2.2,8.1,8.3,5.2,7.9,14.7]
lst_alpha = [.7,.5,.07,.07,.06,.03,.02,.015,.03]
...
out_f = "coop_networks_fullTraj.png"
plt.savefig(out_f)
plt.close()
