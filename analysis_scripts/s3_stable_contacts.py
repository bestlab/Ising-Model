...
def num_contacts_stable(f_in,f_template,numResid):
...
f_num_contacts = [
    'Trp-cage/DESRES-Trajectory_2JOF-0-protein/Contacts/numContacts_stable.dat',
    'BBA/Combined_1FME/numContacts_stable.dat',
    'Villin/DESRES-Trajectory_2F4K-0-protein/Contacts/numContacts_stable.dat',
    'WW domain/Combined_GTT/numContacts_stable.dat',
    'Ntl9/Combined_NTL9/numContacts_stable.dat',
    'Protein G/Combined_NuG2/numContacts_stable.dat',
    'A3D/Combined_A3D/numContacts_stable.dat',
    'Ubiquitin/Combined_1UBQ/numContacts_stable.dat',
    'l-repressor/Combined_lambda/numContacts_stable.dat',
]
f_templates = [
...
for num in range(len(f_num_contacts)):
    contact_matrix = num_contacts_stable(f_num_contacts[num],f_templates[num],lst_nresid[num])
...
out_folder = '00_Figures/s3_stable_contacts/'
...
# reset tick label size
    ...
    plt.title(lst_names[i] + " Stable",fontsize=40)
    #Create legend
    ...
    out_f = out_folder + fname[i] + '_corr_stable.png'
    plt.savefig(out_f)
    plt.close()
