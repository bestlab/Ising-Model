...
class model {
  public:
    ...
    arma::vec h; //Single-site propensities
    arma::vec J; //Coupling parameters
    arma::vec mom1; //First moment
    arma::vec mom2; //Second moment
    ...
    //Constructors
    model();
    model(int N1, double lam, std::string mc_init1);
    //Destructor
    ~model();
